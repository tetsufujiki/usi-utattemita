  ...
  return (
    <section id="faq" aria-labelledby="faq-heading" className="border-b-2 border-foreground bg-secondary px-4 py-16 md:px-8 md:py-20">
      <div className="mx-auto w-full max-w-4xl">
        <div className="flex items-end justify-between gap-4"><div><p className="font-mono text-xs font-bold uppercase tracking-widest">06 / Small FAQ</p><h2 id="faq-heading" className="mt-2 font-heading text-4xl font-black tracking-tight md:text-5xl">ちょっとだけ、確認。</h2></div><span className="hidden -rotate-3 border-2 border-foreground bg-surprise px-3 py-1 font-heading text-sm font-black md:block">5 QUESTIONS</span></div>
